                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" aria-current="page"
                           class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> text-grey-300 hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium text-white">Home</a>
                        <a href="/about"
                        ...
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            <a href="/notes"
                               class="<?= urlIs('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Notes</a>
                        <?php endif; ?>
                        <a href="/contact"
